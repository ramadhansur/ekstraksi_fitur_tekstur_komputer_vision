...
% Last Modified by GUIDE v2.5 28-May-2022 19:50:12
...
% --- Executes on button press in pilih_gambar.
function pilih_gambar_Callback(hObject, eventdata, handles)
% hObject    handle to pilih_gambar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% open=guidata(gcbo);
% [namafile]=uigetfile({'*.jpg;*.png'},'openimage');
% I=imread(namafile);
...
Total = str2double(energi)+str2double(homogenity);
Rata = Total/2;

set(handles.text7,'String',kontras);
set(handles.text8,'String',korelasi);
set(handles.text9,'String',energi);
set(handles.text10,'String',homogenity);
set(handles.text11,'String',Rata);

if(Rata < 0.57)
    set(handles.tekstur,'String','Parah');
end
if(Rata >= 0.57 && Rata < 0.60)
    set(handles.tekstur,'String','Tidak Parah');
end
if(Rata >= 0.60)
    set(handles.tekstur,'String','Tidak Rusak');
end;
